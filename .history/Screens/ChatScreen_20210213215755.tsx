  ...
  render() {
    ...
    const renderSend = (props) => (
      <Send {...props} containerStyle={{}}>
        <Icon
          name="send-outline"
          style={{ borderRadius: 20, margin: 2.5, backgroundColor: "rgba(21, 22, 48, 0.1)", alignItems: "center", justifyContent: "center", }}
          size={35}
          color="black"
        ></Icon>
      </Send>
    ...
    const renderActions = (props) => (
      <Actions
        ...
        onSend={console.log(this.state.messages)} //add logic to pick-a-pic here you idiot..TODO
